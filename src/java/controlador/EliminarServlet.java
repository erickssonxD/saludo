...
public class EliminarServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        registroApp.removeBirthByID(id);

        responseText = "Se ha eliminado el nacimiento correctamente";
        request.setAttribute("responseText", responseText);
        RequestDispatcher despachador = request.getRequestDispatcher("/listar_application.jsp");
